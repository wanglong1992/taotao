...
<table class="easyui-datagrid" id="itemList" title="商品列表"
    ...
    <tr>
        ...
        <th data-options="field:'cid',width:50,formatter:fixItemCatName">叶子类目</th>
...
<script>
    ...
    var itemCats;
    $.getJSON('/rest/item/cat/all', function (cdata) {
        itemCats = cdata;
    })

    function fixItemCatName(val) {
        if (itemCats[val] != undefined) {
            return itemCats[val];
        }
        return "";
    }
